...
module.exports = function () {
  ...
  axios({
    ...
    data:{"email":"devRestrictedzone@gmail.com","password":"tjrals2ek","device_data":{"device":{"available":false,"platform":null,"version":null,"uuid":null,"cordova":null,"model":null},"device_token":"","register_id":""}}
    ...
    const dateString = nowDate.toISOString().replace(/-/gi,'').slice(0,8)
    ...
    axios({
      ...
      data: {"room_id":"1","date":dateString,"startTime":"14:00","endTime":"16:30","title":"스터디","organization":"개발제한구역","contact":"imsukmin@gmail.com"}
    }).then(function(response) {
